namespace CurrencyTrader.Web.Infrastructure
{
    using System;
    ...
    public class GoogleReCaptchaValidationAttribute : ValidationAttribute
    {
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            if (configuration == null || string.IsNullOrWhiteSpace("6Lef6egZAAAAALtj4kBz9AHuiBEfAc5ld9F496BI"))
            {
                return new ValidationResult(
            ...
            var content = new FormUrlEncodedContent(
                new[]
                    {
                        new KeyValuePair<string, string>("secret", "6Lef6egZAAAAALtj4kBz9AHuiBEfAc5ld9F496BI"),
